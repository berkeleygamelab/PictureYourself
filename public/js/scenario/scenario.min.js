...
function ScenarioCtrl($scope, $resource, $http, $compile, Sticker){
    ...
    con.addEventListener('drop',function(e){
        ...
        sticker.scalerX.on('dragmove touchmove',function(){
            ...
            var diff = this.getAbsolutePosition().x - sticker.image.getAbsolutePosition().x - sticker.image.width();
        ...
        sticker.scalerY.on('dragmove touchmove',function(){
            ...
            var diff = this.getAbsolutePosition().y - sticker.image.getAbsolutePosition().y - sticker.image.height();
