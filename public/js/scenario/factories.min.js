	...
	return{
		new : function(imageObj, pos, start_size, layer, imageObjBack){
            ...
            sticker.rotate = new Kinetic.Text({
	            ...
	            name: 'rotate',
	            dragBoundFunc: function(pos) {
	                var x = sticker.image.getAbsolutePosition().x + start_size.width/2;
	                var y = sticker.image.getAbsolutePosition().y + start_size.height/2;  // your center point
	                // var half_width = sticker.image.getWidth();
	                // var half_height = sticker.image.getHeight();
